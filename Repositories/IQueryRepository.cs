...
public interface IQueryRepository
{
    ...
    Task<IQueryResult<Entity>> GetAsync(Expression<Func<Entity, bool>> predicate);
    Task<IQueryResult<Entity>> GetAsync(Expression<Func<Entity, bool>> predicate, int pageSize, int pageIndex);
}
public interface IQueryRepository<TEntity> : IQueryRepository where TEntity : Entity
{
    ...
    abstract Task<IQueryResult<TEntity>> GetByExpressionAsync(Expression<Func<TEntity, bool>> predicate);
    abstract Task<IQueryResult<TEntity>> GetByExpressionAsync(Expression<Func<TEntity, bool>> predicate, int pageSize, int pageIndex);
}